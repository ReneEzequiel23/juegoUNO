...
public class ConfiguracionController {
    ...
    /**
     *  partida es la partida que se configurará
     *  cartasPartida son el número de cartas máximo que un jugador puede tener
     * en la mano
     */
    ...
    /**
     * Metodo para cambiar el número de jugadores máximo dentro de la partida, son de un rango de 2-4 jugadores
     * jugadoresLista, el número de jugadores que hay en la partida
    ...
    /**
     * Metodo para cambiar el tiempo limite del temporizador del turno de cada jugador
     * @param tiempoLimite el tiempo limite nuevo que da el host
     * tiempoPasado: el tiempo limite anterior
     * @return se regresa tiempoPasado si tiempoLimite y tiempoPasado son iguales. Sino, tiempoLimite pasa a ser el nuevo tiempo limite del turno
     * y se regresa tiempoLimite
     */
    ...
    /**
     * Metodo para cambiar el máximo de cartas en la mano de cada jugador, el valor por defecto es 7 cartas máximo
     * @param numCartas el número de cartas en la mano máximo nuevo  
     * @return si numCartas y las cartasPartida son iguales, se retornará cartasPartida sin cambios.
     * Si no son iguales, cartasPartida se actualiza con el valor de numCartas y se retorna cartasPartidas actualizado
     */
